 ...
 */
/**
 * An Operation is made of two bytes which are sliced into four nibbles. These nibbles are then used
 ...
 */
sealed class Operation(val computer: Computer, val nib: Nibbles) {
 ...
 * Clear screen
 */
class Cls(c: Computer, n: Nibbles) : Operation(c, n) {
    override fun run() {
        // TODO 清除屏幕
 ...
 * Return
 */
class Ret(c: Computer, n: Nibbles) : Operation(c, n) {
    override fun run() {
        cpu.PC = cpu.SP.pop()
    }
 ...
 */
class Sys(c: Computer, n: Nibbles) : Operation(c, n) {
    override fun run() {
        cpu.PC -= 2
    }  // loop in place if we reach here
 ...
 * Jump to address
 */
class Jmp(c: Computer, n: Nibbles) : Operation(c, n) {
    override fun run() {
        cpu.PC = nnn - 2
    }
 ...
 */
class Call(c: Computer, n: Nibbles) : Operation(c, n) {
    override fun run() {
        cpu.SP.push(cpu.PC)
        cpu.PC = nnn - 2
    }
 ...
 */
class Se(c: Computer, n: Nibbles) : Operation(c, n) {
    override fun run() {
 ...
 *  Skip next instruction if Vx != kk
 */
class Sne(c: Computer, n: Nibbles) : Operation(c, n) {
    override fun run() {
        if (cpu.V[x] != kk) cpu.PC += 2
    }
 ...
 */
class SeVxVy(c: Computer, n: Nibbles) : Operation(c, n) {
    override fun run() {
 ...
 * Set Vx = kk.
 */
class LdV(c: Computer, n: Nibbles) : Operation(c, n) {
    override fun run() {
        computer.cpu.V[x] = kk
    }
 ...
 * Set Vx = Vx + kk
 */
class Add(c: Computer, n: Nibbles) : Operation(c, n) {
    override fun run() {
        cpu.V[x] = unsigned(cpu.V[x] + kk)
    }
 ...
 * Set Vx = Vy
 */
class Ld(c: Computer, n: Nibbles) : Operation(c, n) {
    override fun run() {
        cpu.V[x] = cpu.V[y]
    }
 ...
 * Set Vx = Vx OR Vy.
 */
class Or(c: Computer, n: Nibbles) : Operation(c, n) {
    override fun run() {
 ...
 * Set Vx = Vx AND Vy.
 */
class And(c: Computer, n: Nibbles) : Operation(c, n) {
    override fun run() {
 ...
 * Set Vx = Vx XOR Vy
 */
class XorVxVy(c: Computer, n: Nibbles) : Operation(c, n) {
    override fun run() {
 ...
 */
class AddVxVy(c: Computer, n: Nibbles) : Operation(c, n) {
    override fun run() {
 ...
 */
class SubVxVy(c: Computer, n: Nibbles) : Operation(c, n) {
    override fun run() {
        val newValue = cpu.V[x] - cpu.V[y]
 ...
 * Set Vx = Vx SHR 1. I
 */
class Shr(c: Computer, n: Nibbles) : Operation(c, n) {
    override fun run() {
        cpu.V[0xf] = cpu.V[x] % 2
 ...
 */
class SubnVxVy(c: Computer, n: Nibbles) : Operation(c, n) {
    override fun run() {
 ...
 * Set Vx = Vx SHL 1. I
 */
class Shl(c: Computer, n: Nibbles) : Operation(c, n) {
    override fun run() {
        cpu.V[0xf] = cpu.V[x] % 2
 ...
 * Set I = nnn.
 */
class LdI(c: Computer, n: Nibbles) : Operation(c, n) {
    override fun run() {
        cpu.I = nnn
    }
 ...
 */
class JumpV0(c: Computer, n: Nibbles) : Operation(c, n) {
    override fun run() {
        cpu.PC = nnn + cpu.V[0]
    }
 ...
 */
class Rnd(c: Computer, n: Nibbles) : Operation(c, n) {
    override fun run() {
        cpu.V[x] = Random.nextInt() and kk
    }
 ...
 */
class Draw(c: Computer, nib: Nibbles) : Operation(c, nib) {
    override fun run() {
        // TODO 绘制
        cpu.V[0xf] = 0
        repeat(n) { byte ->
        ...
        computer.frameBuffer.show(computer.drawListener)
    }
 ...
 */
class LdVDt(c: Computer, n: Nibbles) : Operation(c, n) {
    override fun run() {
        cpu.V[x] = cpu.DT
    }
 ...
 * Set delay timer = Vx.
 */
class LdDt(c: Computer, n: Nibbles) : Operation(c, n) {
    override fun run() {
        cpu.DT = cpu.V[x]
    }
 ...
 * Set sound timer = Vx.
 */
class LdSt(c: Computer, n: Nibbles) : Operation(c, n) {
    override fun run() {
        cpu.ST = cpu.V[x]
    }
 ...
 * Set I = I + Vx.
 */
class AddI(c: Computer, n: Nibbles) : Operation(c, n) {
    override fun run() {
        cpu.I += cpu.V[x]
    }
 ...
 */
class LdF(c: Computer, n: Nibbles) : Operation(c, n) {
    override fun run() {
        cpu.I = cpu.V[x] * 5
    }
 ...
 */
class LdB(c: Computer, n: Nibbles) : Operation(c, n) {
    override fun run() {
        val v = cpu.V[x]
 ...
 */
class LdIVx(c: Computer, n: Nibbles) : Operation(c, n) {
    override fun run() {
        repeat(x + 1) {
 ...
 */
class LdVI(c: Computer, n: Nibbles) : Operation(c, n) {
    override fun run() {
        repeat(x + 1) {
...
class Undef(c: Computer, nib: Nibbles) : Operation(c, nib) {
